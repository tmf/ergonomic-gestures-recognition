...
**
** Created: Thu 27. Jan 10:00:48 2011
...
static const char qt_meta_stringdata_VideoGLWidget[] = {
    "VideoGLWidget\0"
};

const QMetaObject VideoGLWidget::staticMetaObject = {
    { &QGLWidget::staticMetaObject, qt_meta_stringdata_VideoGLWidget,
      qt_meta_data_VideoGLWidget, 0 }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &VideoGLWidget::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_VideoGLWidget))
        return static_cast<void*>(const_cast< VideoGLWidget*>(this));
